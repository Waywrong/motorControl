...
class Robot{
  ...
  Robot(ros::NodeHandle ao_nh) : 
				_motorControl1(7500, ao_nh), _speed(0), _angularSpeed(0), 
				_x(0), _y(0), _heading(0), _old_posL(0), _old_posR(0), 
				_radius(1), _verbose(false), _pnode(ao_nh)
  {
  ...
  Robot(ros::NodeHandle ao_nh, double r, double wr) : 
				_motorControl1(7500, ao_nh), _speed(0), 
				_angularSpeed(0), _radius(r), _wheelRadius(wr), 
				_verbose(false), _pnode(ao_nh)
  {
